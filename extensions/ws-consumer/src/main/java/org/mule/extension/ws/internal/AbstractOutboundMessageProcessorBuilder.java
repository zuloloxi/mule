...
public abstract class AbstractOutboundMessageProcessorBuilder
{
    ...
    public MP build() throws MuleException
    {
        if (muleContext == null) 
        {
        ...
        MP processor = createMessageProcessor();
    ...
    protected MP createMessageProcessor()
    {
        MP processor = new MP(client);
        return processor;
    }

    protected void configureMessageProcessor(MP processor)
    {
    }
