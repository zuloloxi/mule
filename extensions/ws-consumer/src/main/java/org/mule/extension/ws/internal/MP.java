...
public class MP
{
    ...
    public MuleEvent process(MuleEvent event, String action) throws MuleException
    {
        try
        {
    ...
    private MuleException wrapException(MuleEvent event, Throwable ex)
    {

        // TODO FIX.
        return new MessagingException(event, ex);
    ...
    //protected MuleEvent doSendWithProxy(MuleEvent event, String action) throws Exception
    //{
    //    Method method = getMethod(event);
    //
    //    Map<String, Object> props = getInvocationProperties(event);
    //
    ...
    //
    //    return buildResponseMessage(muleRes, objResponse);
    //}
    ...
    protected MuleEvent doSendWithClient(final MuleEvent event) throws Exception
    {
        ...
        if (event.isAllowNonBlocking() && event.getReplyToHandler() != null)
        {
            client.invoke(new ClientCallback()
            {
                ...
                public void handleResponse(Map<String, Object> ctx, Object[] res)
                {
                    try
                    {
                        event.getReplyToHandler().processReplyTo(buildResponseMessage(responseHolder.value, res), null, null);
                    }
        ...
        else
        {
            ...
            return buildResponseMessage(responseHolder.value, response);
        }
    }
    ...
    private Map<String, Object> getInvocationProperties(MuleEvent event)
    {
    ...
    protected MuleEvent buildResponseMessage(MuleEvent transportResponse, Object[] response)
    {
