...
import org.mule.extension.ws.api.WSResponseAttributesBuilder;
...
public class OutputSoapHeadersInterceptor extends AbstractSoapInterceptor
{
    ...
    private final WSResponseAttributesBuilder attributesBuilder;

    public OutputSoapHeadersInterceptor(MuleContext muleContext, WSResponseAttributesBuilder attributesBuilder)
    {
        ...
        for (Header header : message.getHeaders())
        {
            if (header instanceof SoapHeader)
            {
                ...
                try
                {
                    ...
                    attributesBuilder.addHeader(key, value);
                }
                catch (TransformerException e)
                {
                    throw new Fault(new TransformerMessagingException(CoreMessages.createStaticMessage("Cannot parse content of SOAP header %s in the response",
