...
public class NoParamsFunctionalTestCase extends AbstractWSConsumerFunctionalTestCase
{
    ...
    public void payloadIsIgnoredOperationNoParams() throws Exception
    {
        ...
        String expectedResponse = "<ns:noParamsResponse xmlns:ns=\"http://consumer.ws.extension.mule.org/\">" +
    ...
    {
        String header = "<header xmlns=\"http://consumer.ws.extension.mule.org/\">HEADER_VALUE</header>";
        MuleEvent event = flowRunner("noParamsWithHeader").withPayload(TEST_MESSAGE)
                                                          .withOutboundProperty("soap.header", header)
                                                          .run();

        String expectedResponse = "<ns2:noParamsWithHeaderResponse xmlns:ns2=\"http://consumer.ws.extension.mule.org/\">" +
