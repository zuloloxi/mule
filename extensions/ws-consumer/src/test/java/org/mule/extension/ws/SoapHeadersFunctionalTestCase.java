...
public class SoapHeadersFunctionalTestCase extends AbstractWSConsumerFunctionalTestCase
{
    ...
    private static final String ECHO_HEADERS_REQUEST = "<tns:echoWithHeaders xmlns:tns=\"http://consumer.ws.extension.mule.org/\">" +
                                                       "<text>Hello</text></tns:echoWithHeaders>";

    private static final String REQUEST_HEADER_IN = "<headerIn xmlns=\"http://consumer.ws.extension.mule.org/\">TEST_HEADER_1</headerIn>";

    private static final String REQUEST_HEADER_INOUT = "<headerInOut xmlns=\"http://consumer.ws.extension.mule.org/\">TEST_HEADER_2</headerInOut>";

    private static final String RESPONSE_HEADER_OUT = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                                      "<ns2:headerOut xmlns:ns2=\"http://consumer.ws.extension.mule.org/\" " +
                                                      "xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
                                                      "TEST_HEADER_1 OUT</ns2:headerOut>";

    private static final String RESPONSE_HEADER_INOUT = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                                                        "<ns2:headerInOut xmlns:ns2=\"http://consumer.ws.extension.mule.org/\" " +
                                                        "xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" +
