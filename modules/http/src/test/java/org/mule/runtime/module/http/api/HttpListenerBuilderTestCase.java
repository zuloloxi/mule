...
public class HttpListenerBuilderTestCase extends AbstractMuleTestCase {
  ...
  public void createListenerConfigIfThereIsNoMatch() throws Exception {
    ...
    verify(mockListenerConnectionManager).createServer(eq(new DefaultServerAddress(IP, PORT)), any(WorkManagerSource.class),
                                                       eq(true),
  ...
  public void createListenerSslConfigIfThereIsNoMatch() throws Exception {
    ...
    verify(mockListenerConnectionManager).createSslServer(eq(new DefaultServerAddress(IP, PORT)), any(WorkManagerSource.class),
