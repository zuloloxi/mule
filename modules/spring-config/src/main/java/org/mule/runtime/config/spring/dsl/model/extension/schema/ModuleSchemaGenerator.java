...
public class ModuleSchemaGenerator {
  ...
  //TODO check SchemaTypeConversion and SchemaBuilder for visiting the MetadataType
  ...
  private XmlSchema parseModule(ModuleExtension moduleExtension) {
    ...
    //try {System.out.println("Printing schema");schema.write(System.out); } catch (java.io.UnsupportedEncodingException e) { e.printStackTrace(); }
    return schema;
  }
  ...
  private void generateConfig(ModuleExtension moduleExtension, XmlSchema schema) {
    ...
    XmlSchemaComplexType configSchemaType =
        generateConfigSchemaType(schema, moduleExtension.getProperties(), CONFIG_GLOBAL_ELEMENT_NAME);
    ...
    for (ParameterExtension parameterExtension : parameters) {
      ...
      parameterExtension.getType().accept(new MetadataTypeVisitor() {
        ...
        protected void defaultVisit(MetadataType metadataType) {
          //TODO check SchemaTypeConversion and SchemaBuilder
